...
goog.require('hickory.utils');
hickory.core.HiccupRepresentable = (function (){var obj19195 = {};return obj19195;
})();
hickory.core.as_hiccup = (function as_hiccup(this$){if((function (){var and__3527__auto__ = this$;if(and__3527__auto__)
...
{var x__4166__auto__ = (((this$ == null))?null:this$);return (function (){var or__3539__auto__ = (hickory.core.as_hiccup[goog.typeOf(x__4166__auto__)]);if(or__3539__auto__)
{return or__3539__auto__;
} else
{var or__3539__auto____$1 = (hickory.core.as_hiccup["_"]);if(or__3539__auto____$1)
...
hickory.core.HickoryRepresentable = (function (){var obj19197 = {};return obj19197;
})();
hickory.core.as_hickory = (function as_hickory(this$){if((function (){var and__3527__auto__ = this$;if(and__3527__auto__)
...
{var x__4166__auto__ = (((this$ == null))?null:this$);return (function (){var or__3539__auto__ = (hickory.core.as_hickory[goog.typeOf(x__4166__auto__)]);if(or__3539__auto__)
{return or__3539__auto__;
} else
{var or__3539__auto____$1 = (hickory.core.as_hickory["_"]);if(or__3539__auto____$1)
{return or__3539__auto____$1;
} else
...
(hickory.core.as_hiccup["object"] = (function (this$){var pred__19199 = cljs.core._EQ_;var expr__19200 = (this$["nodeType"]);if(cljs.core.truth_(pred__19199.call(null,hickory.core.Attribute,expr__19200)))
...
(hickory.core.as_hickory["object"] = (function (this$){var pred__19202 = cljs.core._EQ_;var expr__19203 = (this$["nodeType"]);if(cljs.core.truth_(pred__19202.call(null,hickory.core.Attribute,expr__19203)))
{return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [hickory.utils.lower_case_keyword.call(null,(this$["name"])),(this$["value"])], null);
} else
{if(cljs.core.truth_(pred__19202.call(null,hickory.core.Comment,expr__19203)))
...
{if(cljs.core.truth_(pred__19202.call(null,hickory.core.Document,expr__19203)))
...
{if(cljs.core.truth_(pred__19202.call(null,hickory.core.DocumentType,expr__19203)))
...
{if(cljs.core.truth_(pred__19202.call(null,hickory.core.Element,expr__19203)))
...
{if(cljs.core.truth_(pred__19202.call(null,hickory.core.Text,expr__19203)))
{return (this$["wholeText"]);
} else
{throw (new Error(("No matching clause: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__19203))));
}
}
}
}
...
hickory.core.extract_doctype = (function extract_doctype(s){var temp__4126__auto__ = cljs.core.second.call(null,(function (){var or__3539__auto__ = cljs.core.re_find.call(null,/<!DOCTYPE ([^>]*)>/,s);if(cljs.core.truth_(or__3539__auto__))
{return or__3539__auto__;
} else
...
var temp__4126__auto___19205 = cljs.core.first.call(null,(doc["head"]["childNodes"]));if(cljs.core.truth_(temp__4126__auto___19205))
{var title_el_19206 = temp__4126__auto___19205;if(cljs.core.empty_QMARK_.call(null,(title_el_19206["text"])))
{hickory.core.remove_el.call(null,title_el_19206);
} else
{}
} else
{}
...
*/
hickory.core.parse = (function parse(s){var or__3539__auto__ = hickory.core.parse_dom_with_domparser.call(null,s);if(cljs.core.truth_(or__3539__auto__))
{return or__3539__auto__;
} else
