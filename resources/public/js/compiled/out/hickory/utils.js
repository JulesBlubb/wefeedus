...
*/
hickory.utils.void_element = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 16, [new cljs.core.Keyword(null,"hr","hr",1013907580),null,new cljs.core.Keyword(null,"meta","meta",1017252215),null,new cljs.core.Keyword(null,"wbr","wbr",1014021753),null,new cljs.core.Keyword(null,"command","command",1964298941),null,new cljs.core.Keyword(null,"source","source",4412365709),null,new cljs.core.Keyword(null,"param","param",1120340991),null,new cljs.core.Keyword(null,"link","link",1017226092),null,new cljs.core.Keyword(null,"col","col",1014002930),null,new cljs.core.Keyword(null,"area","area",1016906751),null,new cljs.core.Keyword(null,"br","br",1013907394),null,new cljs.core.Keyword(null,"input","input",1114262332),null,new cljs.core.Keyword(null,"base","base",1016920643),null,new cljs.core.Keyword(null,"embed","embed",1110524491),null,new cljs.core.Keyword(null,"keygen","keygen",4174205955),null,new cljs.core.Keyword(null,"img","img",1014008629),null,new cljs.core.Keyword(null,"track","track",1124525245),null], null), null);
/**
* Elements whose content should never have html-escape codes.
*/
hickory.utils.unescapable_content = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"script","script",4401185853),null,new cljs.core.Keyword(null,"style","style",1123684643),null], null), null);
...
*/
hickory.utils.render_doctype = (function render_doctype(name,publicid,systemid){return ("<!DOCTYPE "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)+cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(cljs.core.not_empty.call(null,publicid))?(" PUBLIC \""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(publicid)+"\""):null))+cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(cljs.core.not_empty.call(null,systemid))?(" \""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(systemid)+"\""):null))+">");
});
