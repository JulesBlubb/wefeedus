...
{{
var G__19037 = cljs.core.pop.call(null,v__$1);
v__$1 = G__19037;
continue;
}
} else
...
{var pred__19041 = cljs.core._EQ_;var expr__19042 = limit;if(cljs.core.truth_(pred__19041.call(null,1,expr__19042)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__19041.call(null,2,expr__19042)))
...
var G__19044 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__19045 = (limit__$1 - 1);
var G__19046 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__19044;
limit__$1 = G__19045;
parts = G__19046;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___19048 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___19048))
{var replacement_19049 = temp__4124__auto___19048;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_19049)));
} else
{buffer.append(ch);
}
{
var G__19050 = (index + 1);
index = G__19050;
continue;
}
}
