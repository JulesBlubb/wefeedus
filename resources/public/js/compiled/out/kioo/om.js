...
var make_dom__delegate = function (node,body){if(cljs.core.map_QMARK_.call(null,node))
...
make_dom.cljs$lang$applyTo = (function (arglist__19025){
var node = cljs.core.first(arglist__19025);
var body = cljs.core.rest(arglist__19025);
...
var after__delegate = function (body){return (function (node){return cljs.core.cons.call(null,kioo.om.make_dom.call(null,node),body);
});
};
...
after.cljs$lang$applyTo = (function (arglist__19026){
var body = cljs.core.seq(arglist__19026);
...
var before__delegate = function (body){return (function (node){return kioo.util.flatten_nodes.call(null,cljs.core.concat.call(null,body,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [kioo.om.make_dom.call(null,node)], null)));
});
};
...
before.cljs$lang$applyTo = (function (arglist__19027){
var body = cljs.core.seq(arglist__19027);
...
kioo.om.wrap = (function wrap(tag,attrs){return (function (node){return new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"tag","tag",1014018828),tag,new cljs.core.Keyword(null,"sym","sym",1014018617),(React.DOM[cljs.core.name.call(null,tag)]),new cljs.core.Keyword(null,"attrs","attrs",1107056660),kioo.util.convert_attrs.call(null,attrs),new cljs.core.Keyword(null,"content","content",1965434859),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [kioo.om.make_dom.call(null,node)], null)], null);
});
});
