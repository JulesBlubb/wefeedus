...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_26794 = 0;while(true){
if((i_26794 < arr.length))
{(arr[i_26794] = null);
{
...
{var i_26801 = (self__.level + 1);while(true){
if((i_26801 <= (new_level + 1)))
{(update[i_26801] = self__.header);
{
var G__26802 = (i_26801 + 1);
i_26801 = G__26802;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_26803 = 0;while(true){
if((i_26803 <= self__.level))
{var links_26804 = (update[i_26803]).forward;if(((links_26804[i_26803]) === x__$1))
{(links_26804[i_26803] = (x__$1.forward[i_26803]));
{
var G__26805 = (i_26803 + 1);
i_26803 = G__26805;
continue;
}
} else
{{
var G__26806 = (i_26803 + 1);
i_26803 = G__26806;
continue;
}
}
