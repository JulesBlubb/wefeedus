...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t26893 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t26893 = (function (val,box,meta26894){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t26893.cljs$lang$type = true;
cljs.core.async.impl.channels.t26893.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t26893";
cljs.core.async.impl.channels.t26893.cljs$lang$ctorPrWriter = (function (this__4106__auto__,writer__4107__auto__,opt__4108__auto__){return cljs.core._write.call(null,writer__4107__auto__,"cljs.core.async.impl.channels/t26893");
});
cljs.core.async.impl.channels.t26893.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t26893.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_26895){var self__ = this;
var _26895__$1 = this;return self__.meta26894;
});
cljs.core.async.impl.channels.t26893.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_26895,meta26894__$1){var self__ = this;
var _26895__$1 = this;return (new cljs.core.async.impl.channels.t26893(self__.val,self__.box,meta26894__$1));
});
cljs.core.async.impl.channels.__GT_t26893 = (function __GT_t26893(val__$1,box__$1,meta26894){return (new cljs.core.async.impl.channels.t26893(val__$1,box__$1,meta26894));
});
}
return (new cljs.core.async.impl.channels.t26893(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_26896 = self__.takes.pop();if((taker_26896 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_26896))
{var take_cb_26897 = cljs.core.async.impl.protocols.commit.call(null,taker_26896);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_26897,taker_26896,this$__$1){
return (function (){return take_cb_26897.call(null,null);
});})(take_cb_26897,taker_26896,this$__$1))
);
} else
{}
{
